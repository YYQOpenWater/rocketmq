...
public class ConsumerGroupInfo {
    ...
    /**
     * 遍历 subList：
     * 存在 subscriptionTable里面，则判断版本号，是否要更新
     * 不存在，则添加进入{@link ConsumerGroupInfo#subscriptionTable}
     * 再看看{@link ConsumerGroupInfo#subscriptionTable}里面有没有存在 subList 里面没有的topic
     * 有就删掉
     *
     * @param subList
     * @return
